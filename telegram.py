...
class Telegram:
    # TODO ? : Convert this into a simple array and get value by doing "on_"+"value"
    handlerTypeCallback = {
        "update":"on_update",
    ...
    def get_updates(self, offset=0, limit=100, timeout=0):
        return self.send_request("getUpdates", {"offset":offset, "limit":limit, "timeout":timeout})

    def send_message(self, chat_id, text, reply_to_message=None, reply_markup=None):
    ...
    def forward_message(self, chat_id, from_chat_id, message_id):
        return self.send_request("forwardMessage", {"chat_id":chat_id, "from_chat_id":from_chat_id, "message_id": message_id})
